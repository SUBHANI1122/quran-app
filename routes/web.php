...
use App\Http\Controllers\laravel_example\RateManagerController;
use App\Http\Controllers\language\LanguageController;
use App\Http\Controllers\laravel_example\AccountClassificationController;
use App\Http\Controllers\laravel_example\ChartOfAccountController;
...
use App\Http\Controllers\laravel_example\GeneralLedgerController;
use App\Http\Controllers\laravel_example\ImportFileController;
use App\Http\Controllers\RatesReportController;
use App\Http\Controllers\laravel_example\PaymentListController;
use App\Http\Controllers\laravel_example\TransferEntryController;

Auth::routes();
Route::group(['middleware' => 'auth'], function () {
  Route::get('home', [HomeController::class, 'dashboard'])->name('dashboard');
  Route::get('/rates/report', [RatesReportController::class, 'index'])->name('rates.report');
  Route::get('/rates/report/get', [RatesReportController::class, 'getRateReport'])->name('rates.report.get');

  Route::get('/profit_loss/report', [ProfitLossController::class, 'index'])->name('rates.report');
});
// Main Page Route
...
// Rate management
Route::get('/rate-management', [RateManagerController::class, 'rateManagement'])->name('rate-management');
Route::resource('/currency-management', RateManagerController::class);
Route::post('/currency-management/filter', [RateManagerController::class, 'index'])->name('currency-management.filter');


Route::get('/update-rates-list', [RateManagerController::class, 'updateRatesList'])->name('update-rates-list');
Route::post('/update-rates', [RateManagerController::class, 'updateRate'])->name('update-rates');


// Route::get('/currency-management', [RateManagerController::class, 'index'])->name('currency-management');
// Route::post('/currency-management-store', [RateManagerController::class, 'store'])->name('currency-management-store');

Route::resource('/user-list', UserManagement::class);

Route::post('/update-password', [UserManagement::class, 'updatePassword']);

Route::get('/classification', [AccountClassificationController::class, 'accountClassification'])->name('classification');
Route::resource('/account-classification', AccountClassificationController::class);

Route::get('/chart', [ChartOfAccountController::class, 'chartOfAccount'])->name('chart');
Route::resource('/chart-of-account', ChartOfAccountController::class);
Route::post('/chart-of-account/filter', [ChartOfAccountController::class, 'index'])->name('chart-of-account.filter');


Route::get('/importFile-list', [ImportFileController::class, 'create'])->name('import-file-create');
Route::get('/records/{id}/{type}', [ImportFileController::class, 'showRecords'])->name('records.show');
Route::resource('/importFile', ImportFileController::class);

Route::get('/payment-list', [PaymentListController::class, 'create'])->name('payment-list-create');
Route::get('/payment/{id}/{type}', [PaymentListController::class, 'showRecords'])->name('records.show');
Route::resource('/payments-list', PaymentListController::class);
Route::post('/payments-list/filter', [PaymentListController::class, 'index'])->name('payment-list.filter');
Route::post('/process-records', [PaymentListController::class, 'processRecords'])->name('process.records');

Route::get('/ledger', [GeneralLedgerController::class, 'generalLedger'])->name('general.ledger');
Route::resource('/general-ledger', GeneralLedgerController::class);
Route::post('/general-ledger/filter', [GeneralLedgerController::class, 'index'])->name('general-ledger.filter');
Route::get('/fetch-general-ledger', [GeneralLedgerController::class, 'fetchGeneralLedger'])->name('fetch.general.ledger');

Route::get('/transfer_entry', [TransferEntryController::class, 'transferEntry'])->name('transfer.entry');
Route::resource('/transfer-entry', TransferEntryController::class);
Route::get('/get-rate/{accountId}', [TransferEntryController::class, 'getRate']);
Route::patch('/transfer-entries/post', [TransferEntryController::class, 'postEntries'])->name('transfer-entry.post');
Route::get('/temp-transfer-entries', [TransferEntryController::class, 'tempEntries'])->name('temp-entry');
Route::post('/approve-entries-for-date', [TransferEntryController::class, 'approveEntriesForDate']);
Route::delete('/delete-entries-for-date', [TransferEntryController::class, 'deleteEntriesForDate']);
