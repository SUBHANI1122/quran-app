...
'resources/js/modal-add-currency.js'])
...
<div class="d-flex justify-content-between align-items-center m-5">
    ...
    <button type="button" class="btn btn-primary add-new" data-bs-toggle="modal" data-bs-target="#addCurrency">Add Currency</button>
</div>
    ...
    <div class="card-datatable table-responsive">
        <table class="table datatables-currency">
            <thead>
                <tr>
...
<!-- /Advanced Search -->
@include('_partials/_modals/modal-currency')
@endsection